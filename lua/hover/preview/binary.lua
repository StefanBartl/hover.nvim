...
--- decide from the bytes. `hover.formats` is consulted only for a
...
function M.badge(target, opts)
  opts = opts or {}
  local label = opts.label or require("hover.formats").label(target.ext) or "binary file"
